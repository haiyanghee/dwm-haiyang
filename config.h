...
static const char *fonts[] = {"monospace:size=11","Noto Color Emoji:pixelsize=11:antialias=true:autohint=true"};
static const char dmenufont[] = "monospace:size=11";
static const char col_gray1[] = "#222222"; //asdf
...
// "~/Screenshots/%s_%H%M_%d.%m.%Y_$wx$h.png", NULL}; static const char
// *scrShotWindow[]  = { "scrot", "-u",
// "~/Screenshots/%s_%H%M_%d.%m.%Y_$wx$h.png", NULL};

static const char *scrShot[] = {"scrot", "%Y-%m-%d-%H%M%S.png", "-e",
				"mv $f ~/Screenshots", NULL};
static const char *scrShotWindow[] = {
...
static Key keys[] = {
    ...
    {KeyPress, MODKEY | ShiftMask, XK_Tab, focusmon, {.i = -1}},
